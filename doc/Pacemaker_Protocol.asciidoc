...
A status of *device available* indicates that the device has no explicitly detected hardware or configuration errors currently.
...
| 2 | accelation/deceleration rate for underrun avoidance (in steps per second per second) for stepper 0
| 2 | maximum movement rate (in steps per second) during underrun avoidance for stepper 1
| 2 | accelation/deceleration rate for underrun avoidance (in steps per second per second) for stepper 1
| 2 | maximum movement rate (in steps per second) during underrun avoidance for stepper 2
| 2 | accelation/deceleration rate for underrun avoidance (in steps per second per second) for stepper 2
| .. | 
| 2 | maximum movement rate (in steps per second) during underrun avoidance for stepper N-1
| 2 | accelation/deceleration rate for underrun avoidance (in steps per second per second) for stepper N-1
|=============================
