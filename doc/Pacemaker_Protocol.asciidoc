...
The *Length* field indicates the number of bytes used by the Parameter field, the control and the Reply or Order code in the Order frame and in the Reply frame.
